...
const EditOutlineIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    fill={'none'}
    height={'24'}
    ref={ref}
  ...
  >
    <defs>
      <clipPath id={'edit-outline_svg__a'}>
        <rect
          fill={'#fff'}
          fillOpacity={0}
          height={23}
    ...
    <g clipPath={'url(#edit-outline_svg__a)'} fill={'currentColor'}>
      <path
        d={
...
const ForwardRef = forwardRef(EditOutlineIcon)
