...
const MicOutlineIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg
    fill={'none'}
    height={'24'}
    ref={ref}
  ...
  >
    ...
    <g clipPath={'url(#mic-outline_svg__a)'} fill={'currentColor'}>
      <path
        d={
          'M12 15c1.06 0 2.07-.43 2.82-1.18A4 4 0 0 0 16 11V6c0-1.07-.43-2.08-1.18-2.83A3.98 3.98 0 0 0 12 2c-1.07 0-2.08.42-2.83 1.17S8 4.93 8 6v5c0 1.06.42 2.07 1.17 2.82S10.93 15 12 15m-2-9c0-.54.21-1.04.58-1.42a2.016 2.016 0 0 1 2.83 0c.37.38.59.88.59 1.42v5c0 .53-.22 1.03-.59 1.41-.38.37-.88.59-1.41.59-.54 0-1.04-.22-1.42-.59-.37-.38-.58-.88-.58-1.41z'
        }
      />
      <path
        d={
...
const ForwardRef = forwardRef(MicOutlineIcon)
